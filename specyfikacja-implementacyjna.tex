...
Kontroler \f{SplinesController}, w~teorii powinien zarządzać całym programem na
wyższym poziomie abstrakcji niż reszta klas. Jego jedynym zadaniem jest
odpowiadanie na eventy przychodzące z~\f{SplinesView} i~wywoływanie
odpowiednich metod na modelach.

Posiada publiczny konstruktor wywoływany w~\f{main()}.
